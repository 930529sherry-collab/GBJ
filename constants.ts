...
export const MISSIONS_FOR_IMPORT: Array<Omit<Mission, 'current' | 'status' | 'claimed'>> = [
    ...
    },
    {
    ...
    },
     {
      id: "daily_night_owl",
      title: "夜貓子",
      description: "不醉不歸！在深夜時段（00:00 - 04:00）完成一次酒吧打卡，享受城市的寧靜。",
      xpReward: 80,
      type: "daily",
      target: 1,
    },
    {
      id: "daily_weekend_warrior",
      title: "週末戰士",
      description: "工作辛苦了！在週六或週日前往酒吧打卡，放鬆一週的疲憊。",
      xpReward: 60,
      type: "daily",
      target: 1,
    },
    {
      id: "daily_friday_fever",
      title: "週五狂熱夜",
      description: "在最期待的週五夜晚前往任何酒吧打卡，用一杯好酒迎接週末自由。",
      xpReward: 50,
      type: "daily",
      target: 1,
    },
    {
      id: "daily_early_bird",
      title: "早鳥優惠",
      description: "懂得把握時間的聰明酒客！在傍晚 5 點到 7 點的 Happy Hour 黃金時段完成打卡。",
      xpReward: 50,
      type: "daily",
      target: 1,
    },
    ...
    {
      id: "special_first_check_in",
      title: "初來乍到",
      description: "完成你的第一次酒吧打卡，為你的酒吧探險傳奇寫下精彩序幕。",
      xpReward: 100,
      pointsReward: 50,
      type: "special",
      target: 1,
    ...
    {
      id: "special_photo_post",
      title: "微醺留影",
      description: "用照片記錄歡樂瞬間！發布一則附帶照片的動態，讓大家看看你的微醺模樣。",
      xpReward: 50,
      type: "special",
      target: 1,
    },
    {
      id: "special_reviewer",
      title: "評論家",
      description: "你的舌尖是社群米其林指南。為 3 間造訪過的酒吧留下星級評論與心得。",
      xpReward: 80,
      type: "special",
      target: 3,
    },
    {
      id: "special_social_butterfly",
      title: "社交蝴蝶",
      description: "展現你的揪團魅力！一週內發布 5 篇與不同好友歡聚的動態，成為派對核心。",
      xpReward: 60,
      type: "special",
      target: 5,
    },
    {
      id: "special_loyal_customer",
      title: "忠實顧客",
      description: "在同一間心愛酒吧累積打卡 5 次，讓調酒師都記得你，成為店家認證 VIP！",
      xpReward: 100,
      type: "special",
      target: 5,
    },
    {
      id: "special_explorer",
      title: "探險家",
      description: "挑戰極限！在動態一晚內探訪 3 間不同風格酒吧並打卡，證明你是城市酒吧專家。",
      xpReward: 100,
      pointsReward: 20,
      type: "special",
      target: 3,
    },
    {
      id: "special_popular",
      title: "人氣王",
      description: "你是社群焦點！發布的一則動態獲得 30 個讚，證明你的高人氣！",
      xpReward: 80,
      type: "special",
      target: 30,
    },
    {
      id: "special_ultimate_explorer",
      title: "終極探險家",
      description: "城市霓虹都為你而亮！累積在 10 間完全不同的酒吧打卡，解鎖榮耀稱號。",
      xpReward: 150,
      pointsReward: 100,
      type: "special",
      target: 10,
