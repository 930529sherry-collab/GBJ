...
const StoreDetail: React.FC<{ 
    ...
    useEffect(() => {
        const favoriteStoreIds = JSON.parse(localStorage.getItem('favoriteStoreIds') || '[]') as (number | string)[];
    ...
    const handleToggleFavorite = () => {
        checkGuest(() => {
            ...
            if (favoriteStoreIds.includes(storeId)) {
                updatedIds = favoriteStoreIds.filter((id) => id !== storeId);
            } else {
...
const ReviewsTab: React.FC<{ 
    ...
    // @-fix: Safely sort reviews by converting potentially string IDs to numbers.
